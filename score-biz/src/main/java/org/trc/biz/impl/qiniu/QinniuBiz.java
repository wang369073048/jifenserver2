package org.trc.biz.impl.qiniu;
...
public class QinniuBiz implements IQinniuBiz {
    ...
    private BaseThumbnailSize getBaseThumbnailSize(String module){
        ...
        if(StringUtils.equals(module, ScoreAdminConstants.Route.QinNiu.Module.PROPERTY)){//属性管理
            baseThumbnailSize = new PropertyThumbnailSize();
        }else if(StringUtils.equals(module, ScoreAdminConstants.Route.QinNiu.Module.SUPPLY)){//供应商管理
            //baseThumbnailSize = new PropertyThumbnailSize();
        }else {
            //
        }
