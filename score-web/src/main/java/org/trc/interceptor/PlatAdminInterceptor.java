...
@Component
public class PlatAdminInterceptor extends BaseInterceptor implements MethodInterceptor {

    private Logger logger = LoggerFactory.getLogger(PlatAdminInterceptor.class);

    public PlatAdminInterceptor() {
    ...
    public Object invoke(MethodInvocation methodInvocation) throws Throwable {
        try {
            ...
            if ( null == manager || !RoleType.PlAT_ADMIN.name().equals(manager.getRoleType())){
