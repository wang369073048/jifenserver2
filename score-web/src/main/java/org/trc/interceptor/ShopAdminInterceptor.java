...
@Component
public class ShopAdminInterceptor extends BaseInterceptor implements MethodInterceptor {

    private Logger logger = LoggerFactory.getLogger(ShopAdminInterceptor.class);

    public ShopAdminInterceptor() {
    ...
    public Object invoke(MethodInvocation methodInvocation) throws Throwable {
        try {
            ...
            if ( null == manager || !RoleType.SHOP_ADMIN.name().equals(manager.getRoleType())){
