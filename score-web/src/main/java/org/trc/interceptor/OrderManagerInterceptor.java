...
@Component
public class OrderManagerInterceptor extends BaseInterceptor implements MethodInterceptor {

    private Logger logger = LoggerFactory.getLogger(OrderManagerInterceptor.class);

    public OrderManagerInterceptor() {
    ...
    public Object invoke(MethodInvocation methodInvocation) throws Throwable {
        try {
            ...
            if ( null == manager || !RoleType.ORDER_MANAGER.name().equals(manager.getRoleType())){
