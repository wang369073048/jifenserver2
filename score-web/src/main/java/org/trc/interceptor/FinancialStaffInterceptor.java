...
@Component
public class FinancialStaffInterceptor extends BaseInterceptor implements MethodInterceptor {

    private Logger logger = LoggerFactory.getLogger(FinancialStaffInterceptor.class);

    public FinancialStaffInterceptor() {
    ...
    public Object invoke(MethodInvocation methodInvocation) throws Throwable {
        try {
            ...
            if ( null == manager || !RoleType.FINANCIAL_STAFF.name().equals(manager.getRoleType())){
