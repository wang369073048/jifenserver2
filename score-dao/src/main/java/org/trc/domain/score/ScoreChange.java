...
public class ScoreChange implements Serializable {
    ...
    public String theOtherUserId;       //对方用户标示
    @Column(name = "theOtherUserName")
    public String theOtherUserName;             //对方名
    @Column(name = "scoreId")
    public Long scoreId;                 //积分账户id
    @Column(name = "foreignCurrency")
    public Long foreignCurrency;        //外币变更数量

    public Long score;                   //积分变更数量
    @Column(name = "scoreBalance")
    public Long scoreBalance;           //积分余额
    @Column(name = "freezingScoreBalance")
    public Long freezingScoreBalance;  //冻结积分余额
    ...
    public String flowType;             //变更类型(income:收入，expenditure:支出)
    @Column(name = "exchangeCurrency")
    public String exchangeCurrency;    //外币

    public String remark;               //备注
    @Column(name = "operationTime")
    public Date operationTime;         //操作时间
    @Column(name = "expirationTime")
    public Date expirationTime;        //过期时间
